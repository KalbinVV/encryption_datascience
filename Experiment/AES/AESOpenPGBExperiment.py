...
class AESOpenPGBExperiment(Experiment):
    ...
    def get_cipher(self) -> Cipher:
        return AES.new(self.__key, AES.MODE_OPENPGP)

    def get_fields_names(self) -> tuple:
        return 'AES MODE_OPENPGP, Время шифрования (с)', 'AES MODE_OPENPGP, Время расшифрования (с)'
